...
def bing_search():
    ...
    try:
        ...
        speak("NLTK words data is missing. Bing search is disabled.")
        return
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if any(word in query for word in [
            ...
            speak("enter confirm to exit or cancel to continue")
            confirm = command()
            # confirm  = input("enter confirm to exit or cancel to continue ")
